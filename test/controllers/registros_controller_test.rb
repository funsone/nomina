...
class RegistrosControllerTest < ActionController::TestCase
  ...
  test "should create registro" do
    assert_difference('Registro.count') do
      post :create, registro: { descripcion: @registro.descripcion, tipo_de_accion: @registro.tipo_de_accion, usuario_id: @registro.usuario_id }
    end
  ...
  test "should update registro" do
    patch :update, id: @registro, registro: { descripcion: @registro.descripcion, tipo_de_accion: @registro.tipo_de_accion, usuario_id: @registro.usuario_id }
    assert_redirected_to registro_path(assigns(:registro))
  end
