...
class ConceptospersonalesControllerTest < ActionController::TestCase
  setup do
    @conceptopersonal = conceptospersonales(:one)
  end

  test "should get index" do
    get :index
    assert_response :success
    assert_not_nil assigns(:conceptospersonales)
  end
  ...
  test "should destroy conceptopersonal" do
    ...
    assert_redirected_to conceptospersonales_path
  end
end
